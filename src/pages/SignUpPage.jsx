      ...
      <div className="flex-1 flex flex-col justify-center px-6 sm:px-12 lg:px-16 py-12 relative overflow-y-auto">
        ...
        <div className="relative z-10 w-full max-w-md mx-auto">
          ...
          <div className="relative">
            <button
              type="button"
              onClick={() => { setGoogleTooltip(true); setTimeout(() => setGoogleTooltip(false), 2000) }}
              className="w-full py-3 rounded-xl border border-gray-700 text-sm text-gray-400 hover:border-gray-500 hover:text-gray-300 transition-colors flex items-center justify-center gap-3"
            >
            ...
            {googleTooltip && (
              <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 text-xs bg-gray-800 text-gray-300 px-3 py-1.5 rounded-lg whitespace-nowrap z-10">
                Coming soon
              </div>
            )}
          </div>
